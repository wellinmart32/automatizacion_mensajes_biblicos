...
if __name__ == "__main__":
    # Registrar AppUserModelID para icono correcto en barra de tareas
    try:
        import ctypes
        ctypes.windll.shell32.SetCurrentProcessExplicitAppUserModelID('AutomaPro.MensajesBiblicos')
    except Exception:
        pass
